              ...
              <div className="divide-y-4">
                  ...
                  <div className="row">
                    ...
                    <div className="col">
                      <div className="text-truncate">
                        <strong>Phạm Hạnh</strong> mentioned you in <strong>[Thoka] #Lean Model Canvas</strong>.
                      </div>
                ...
                <div>
                  <div className="row">
                    ...
                    <div className="col">
                      <div className="text-truncate">
                        <strong>Bảo Trương</strong> assigned you to a new task in <strong>[Thoka] #Thiết kế Logo</strong>.
                      </div>
                      <div className="text-muted">yesterday</div>
                    </div>
                    <div className="col-auto align-self-center">
                ...
                <div>
                  <div className="row">
                    ...
                    <div className="col">
                      <div className="text-truncate">
                        <strong>Elon Musk</strong> sent you a private message in <strong>[Thoka]</strong>.
                      </div>
                      <div className="text-muted">2 days ago</div>
                    </div>
                  </div>
